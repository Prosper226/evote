			...
			<!-- Banner -->
				<div id="banner-wrapper">
					<div id="banner" class="box container">
						<div class="row">
							<div class="col-lg-12 col-12-medium">
								<h2><u>#Candidatures fermees</u></h2>
								<p></p>
							</div>
							<!-- <div class="col-lg-6 col-12-medium">
								<ul>
									<li><a href="candidatures_step1.php" class="button large icon solid fa-arrow-circle-right">Prêt à candidater</a></li>
									<li><a href="#" class="button large icon solid fa-arrow-circle-right" data-toggle="modal" data-target="#exampleModalCenter">Cliquez pour postuler</a></li>
							...
							<div class="modal-body">
								<form role="form" action="actions/login.php" method="post">
									<div class="form-group">
										<input type="hidden" class="form-control" id="link" name="link" value="candidatures">
