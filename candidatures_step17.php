<?php
	...
	if (isset($_GET['parti'])&&!empty($_GET['parti'])){
		$parti = $_GET['parti'];
		$poste = "délégué adjoint chargé des clubs";
		$nextStep = 18;
		$steps = '17/17';
					...
					<div id="banner" class="box container">
						<div class="row">
							<div class="col-7 col-12-medium">
								...
								<input type="hidden" class="form-control" name="poste" value="<?=$poste?>" id="poste">
							...
							<div class="col-5 col-12-medium">
								<ul>
									<li><a href="candidatures_step<?=$nextStep?>.php?parti=<?=$parti ?>" id="btn_next_steps" class="button large icon solid fa-arrow-circle-right">Voir resumé</a></li>
