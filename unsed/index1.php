				...
				<div id="header-wrapper">
					<header id="header" class="container">
						...
						<!-- Nav -->
							<nav id="nav">
								<ul>
									<li class="current"><a href="index.php"><i class="fa fa-home"></i>Accueil</a></li>
					...
					<div id="banner" class="box container">
						<div class="row">
							<div class="col-7 col-12-medium">
								<h2>Bienvenue sur ESTA evote.</h2>
								<p>ESTA evote est une plateforme web, concue pour permettre des élections libres et transparentes au sein de notre très chère école (ESTA)</p>
							</div>
							<div class="col-5 col-12-medium">
								<ul>
									<li><a href="votes.php" class="button large icon solid fa-arrow-circle-right">Prêt à voter</a></li>
