					...
					<div id="banner" class="box container">
						<div class="row">
							<div class="col-7 col-12-medium">
								<h2><u>Liste des candidats</u></h2>
								
							</div>
							<div class="col-5 col-12-medium">
								<ul>
									<li><a class="button large icon solid fa-arrow-circle-left" id="precedent">Précédent</a></li>
							...
							foreach($PARTIS as $parti){
								...
								<table class="table">
									<thead class="thead-light">
										<tr><th colspan = 3><center>Liste des membres du <?=$parti_nom?></center></th></tr>
										<tr>
										<!--th scope="col">#</th-->
									...
									<tbody>
										<?php 
											$MEMBERS = $crud->get_part_members($parti_nom);
											$i = 0;
											foreach ($MEMBERS as $key => $member){
												...
												$poste = $member['poste']; 
												$classe = $member['niveau'].'-'.$member['filiere'];
											?>
											<tr>
											<td><?=$poste?></td>
											<td><?=$nomprenom?></td>
